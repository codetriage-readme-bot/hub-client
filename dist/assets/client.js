...
define('client/components/teams/teams-settings', ['exports', 'ember'], function (exports, _ember) {
  var getOwner = _ember['default'].getOwner;
  exports['default'] = _ember['default'].Component.extend({
    store: _ember['default'].inject.service(),
    actions: {
...
define('client/components/users/users-settings', ['exports', 'ember'], function (exports, _ember) {
  var getOwner = _ember['default'].getOwner;
  exports['default'] = _ember['default'].Component.extend({
    store: _ember['default'].inject.service(),
    actions: {
    ...
    var child1 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("h2");
          var el2 = dom.createTextNode("Your awesome Card");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el3, "alt", "Dashboard");
        dom.appendChild(el2, el3);
...
define("client/templates/components/teams/teams-settings", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        meta: {
          ...
          "moduleName": "client/templates/components/teams/teams-settings.hbs"
        },
        isEmpty: false,
        arity: 0,
        cachedFragment: null,
        ...
        statements: [["element", "action", ["isNotEditing", ["get", "team.id", ["loc", [null, [3, 77], [3, 84]]], 0, 0, 0, 0]], [], ["loc", [null, [3, 52], [3, 86]]], 0, 0]],
        locals: [],
        templates: []
      };
    })();
    var child1 = (function () {
      return {
        ...
        statements: [["element", "action", ["isEditing", ["get", "team.id", ["loc", [null, [5, 74], [5, 81]]], 0, 0, 0, 0]], [], ["loc", [null, [5, 52], [5, 83]]], 0, 0]],
        locals: [],
        templates: []
      };
    })();
    return {
      ...
      statements: [["block", "if", [["get", "isEditing", ["loc", [null, [2, 8], [2, 17]]], 0, 0, 0, 0]], [], 0, 1, ["loc", [null, [2, 2], [6, 9]]]]],
      locals: [],
      templates: [child0, child1]
    };
  })());
...
define("client/templates/components/users/users-settings", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        meta: {
          ...
          "moduleName": "client/templates/components/users/users-settings.hbs"
        },
        isEmpty: false,
        arity: 0,
        cachedFragment: null,
        ...
        statements: [["element", "action", ["isNotEditing", ["get", "user.id", ["loc", [null, [3, 77], [3, 84]]], 0, 0, 0, 0]], [], ["loc", [null, [3, 52], [3, 86]]], 0, 0]],
        locals: [],
        templates: []
      };
    })();
    var child1 = (function () {
      return {
        ...
        statements: [["element", "action", ["isEditing", ["get", "user.id", ["loc", [null, [5, 74], [5, 81]]], 0, 0, 0, 0]], [], ["loc", [null, [5, 52], [5, 83]]], 0, 0]],
        locals: [],
        templates: []
      };
    })();
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("img");
        dom.setAttribute(el7, "src", "/assets/fonts/insight.svg");
        dom.setAttribute(el7, "class", "c-side-bar__icon");
      ...
      statements: [["content", "layout/side-bar", ["loc", [null, [3, 4], [3, 23]]], 0, 0, 0, 0], ["content", "layout/secondary-nav-bar", ["loc", [null, [6, 4], [6, 32]]], 0, 0, 0, 0], ["content", "outlet", ["loc", [null, [16, 6], [16, 16]]], 0, 0, 0, 0]],
      locals: [],
      templates: []
    };
  })());
...
define("client/templates/project/new", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    var child1 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("h2");
          var el2 = dom.createTextNode("Your awesome Project");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
    ...
    return {
      ...
      statements: [["content", "layout/side-bar", ["loc", [null, [3, 4], [3, 23]]], 0, 0, 0, 0], ["content", "layout/secondary-nav-bar", ["loc", [null, [6, 4], [6, 32]]], 0, 0, 0, 0], ["block", "if", [["get", "model.title", ["loc", [null, [10, 16], [10, 27]]], 0, 0, 0, 0]], [], 0, 1, ["loc", [null, [10, 10], [14, 17]]]], ["inline", "forms/new-project-form", [], ["model", ["subexpr", "@mut", [["get", "model", ["loc", [null, [26, 45], [26, 50]]], 0, 0, 0, 0]], [], [], 0, 0]], ["loc", [null, [26, 14], [26, 52]]], 0, 0], ["block", "if", [["get", "model.description", ["loc", [null, [34, 22], [34, 39]]], 0, 0, 0, 0]], [], 2, 3, ["loc", [null, [34, 16], [38, 23]]]]],
      locals: [],
      templates: [child0, child1, child2, child3]
    };
  })());
...
define("client/templates/team/new", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    var child1 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("h2");
          var el2 = dom.createTextNode("Your awesome Team");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
    ...
    return {
      ...
      statements: [["content", "layout/side-bar", ["loc", [null, [3, 4], [3, 23]]], 0, 0, 0, 0], ["content", "layout/secondary-nav-bar", ["loc", [null, [6, 4], [6, 32]]], 0, 0, 0, 0], ["block", "if", [["get", "model.title", ["loc", [null, [10, 16], [10, 27]]], 0, 0, 0, 0]], [], 0, 1, ["loc", [null, [10, 10], [14, 17]]]], ["inline", "forms/new-team-form", [], ["model", ["subexpr", "@mut", [["get", "model", ["loc", [null, [26, 42], [26, 47]]], 0, 0, 0, 0]], [], [], 0, 0]], ["loc", [null, [26, 14], [26, 49]]], 0, 0], ["block", "if", [["get", "model.description", ["loc", [null, [34, 22], [34, 39]]], 0, 0, 0, 0]], [], 2, 3, ["loc", [null, [34, 16], [38, 23]]]]],
      locals: [],
      templates: [child0, child1, child2, child3]
    };
  })());
...
define("client/templates/team/team", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["content", "layout/side-bar", ["loc", [null, [3, 4], [3, 23]]], 0, 0, 0, 0], ["content", "layout/secondary-nav-bar", ["loc", [null, [6, 4], [6, 32]]], 0, 0, 0, 0], ["content", "team.name", ["loc", [null, [12, 12], [12, 25]]], 0, 0, 0, 0], ["inline", "teams/teams-settings", [], ["team", ["subexpr", "@mut", [["get", "model", ["loc", [null, [16, 38], [16, 43]]], 0, 0, 0, 0]], [], [], 0, 0]], ["loc", [null, [16, 10], [16, 45]]], 0, 0], ["content", "outlet", ["loc", [null, [20, 8], [20, 18]]], 0, 0, 0, 0], ["content", "team.description", ["loc", [null, [25, 16], [25, 38]]], 0, 0, 0, 0]],
      locals: [],
      templates: []
    };
  })());
...
if (!runningTests) {
  require("client/app")["default"].create({"name":"client","version":"0.0.0+0f678fae"});
}
